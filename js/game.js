    ...
    squares.forEach(function(square) {
      ...
      // for hint and stepsAway
        ...
        if(pointX == xAxisTreasurePoint && pointY == yAxisTreasurePoint){
            ...
            board[xAxis][yAxis].innerHTML = "<img src='./images/Treasure.png' height='75' width='75'>";
        }
        else { 
          // changeBoxColor(xAxis, yAxis, "white");
          board[xAxis][yAxis].innerHTML = "<img src='./images/Hole_in_Ground.png' height='75' width='75'>";
        }
